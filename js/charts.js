...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // variable that filters the metadata array
    var metadata = data.metadata;
  ...
  var gaugeData = {
    ...
    gauge: {
      axis: {range: [0,10]},
      steps: [
        {range: [0,2], color:"#EA3323"},
        {range: [2,4], color:"#F2A93B"},
        {range: [4,6], color:"#FFFF54"},
        {range: [6,8], color:"#A5CC4F"},
        {range: [8,10], color:"#377E22"}
      ]
    }
  };
